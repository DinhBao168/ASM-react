      ...
      .then((users) => {
        if (users.length > 0) {
          ...
          if (user.password === password) {
            ...
            if (user.role === 'admin') {
              navigation.navigate('Admin'); // Đảm bảo Admin được khai báo trong navigation
            } else {
              navigation.navigate('Main'); // Đảm bảo Main được khai báo trong navigation
            }
          } else {
            setError('Sai mật khẩu'); // Cập nhật lỗi
          }
        } else {
